...
/**
 * {@link ChangeVector} is the change vector class to be used in the client application. Instances of this class
 * already had their {@link AbstractChangeVector#getPreviousValue()} converted from its JSON representation to the
 * original type, as specified by {@link JsonChangeVector#getAttributeType()}.
 *
...
public class ChangeVector extends AbstractChangeVector<Object> {
	public ChangeVector(
		...
		@NotNull EntityStrategy<?> entityStrategy
