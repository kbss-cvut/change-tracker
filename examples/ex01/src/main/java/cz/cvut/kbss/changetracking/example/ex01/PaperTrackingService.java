...
public class PaperTrackingService {
	...
	@Autowired
	public PaperTrackingService(@Qualifier("entityManager") EntityManager jopaEm, javax.persistence.EntityManager jpaEm) {
		this.jopaEm = jopaEm;
	 ...
	 * revision.
	 */
	public void saveChanges(ConferencePaper newer) {
